<template>
  ...
  <div :hidden="question1" class="text-center items-center justify-center">
    <h1>Question 1</h1>
...
export default defineComponent({
  ...
  setup() {
    ...
    const question2 = ref(true);
    const question3 = ref(true);
    const question4 = ref(true);
    const question5 = ref(true);
    const question6 = ref(true);
    const question7 = ref(true);
    const question8 = ref(true);
    ...
    const budget1 = ref({ prix: 250, clicked: false });
    const budget2 = ref({ prix: 500, clicked: false });
